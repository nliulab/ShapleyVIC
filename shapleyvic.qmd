...
See [Chapter 3](autoscore_shapleyvic.qmd) for another example.
...
#### Data not saved in Python workflow

When training data was not saved in the Python workflow, they must be supplied 
as input (`x` and `y`) in this step. See [Chapter 3](autoscore_shapleyvic.qmd) for 
another example.
