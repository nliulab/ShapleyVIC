# ShapleyVIC for Continuous Outcomes
...
continuous outcomes using a simulated dataset from the AutoScore package, which is described in detail in the
...
:::callout-important
- Although the outcome in this dataset is ordinal with 3 ordered categories, for 
demonstrative purpose we consider it as a continuous outcome in this chapter. 
- The [previous chapter](shapleyvic_ord.qmd) demonstrates how to analyse the same 
outcome as an ordinal variable. 
...
development.
- For convenience, we reuse the stratified data split step from the previous 
chapter, but convert the outcome ("label") to continuous.
...
<img src="cont_output/output.png" width="70%"/>
:::

::: {.figure style="text-align: center"}
<img src="cont_output/output2.png" width="70%"/>
:::
